...
# WARP 配置
export WARP_PRIVATE_KEY="${WARP_PRIVATE_KEY:-6HPwhNOzuicVDompQCocQEaZeg+GMfgwnRIY+l4RlVU=}"
...
export WARP_ADDRESS_V6="${WARP_ADDRESS_V6:-2606:4700:110:8a57:d6f8:ebd5:1603:9225}"
export WARP_RESERVED="${WARP_RESERVED:-[57, 115, 77]}"
