...
const SUB_PATH = process.env.SUB_PATH || '824e635626cd/sub';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || '9076ba42-d727-4599-9491-7615ee9844de'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const NAME = process.env.NAME || 'Vls-eu';                     // 节点名称
